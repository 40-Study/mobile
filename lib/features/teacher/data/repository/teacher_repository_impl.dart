...
class TeacherRepositoryImpl implements TeacherRepository {
  ...
  /// Get teacher wallet theo API DOCS - GET /wallet/teacher/me
  ...
  Future<TeacherWalletModel> getWallet() async {
    ...
    return const TeacherWalletModel(
      ...
      userId: 'teacher-001',
      totalEarnings: '125850000',
      totalPaidOut: '80570000',
      availableBalance: '45280000',
      currency: 'VND',
      orderCount: 156,
      bankName: 'Techcombank',
      bankAccountNumber: '19025678901234',
      bankAccountName: 'NGUYEN VAN TEACHER',
  ...
  /// Mock courses theo API DOCS - GET /courses
  ...
  List<CourseModel> _getMockCourses(String? status) {
    final courses = [
      CourseModel(
        ...
        slug: 'thiet-ke-ui-ux-nang-cao-2024',
        shortDescription: 'Khóa học toàn diện về thiết kế UI/UX',
        description: 'Học cách thiết kế giao diện người dùng chuyên nghiệp',
        thumbnailUrl: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=400',
        previewVideoUrl: 'https://example.com/preview-uiux.mp4',
        level: 'advanced',
        language: 'vi',
        price: '1990000',
        discountPrice: '1490000',
        discountExpiresAt: '2024-04-30T23:59:59Z',
        totalDurationMinutes: 1200,
        totalLessons: 45,
        totalStudents: 1240,
        averageRating: '4.8',
        totalReviews: 256,
        requirements: ['Kiến thức cơ bản về thiết kế', 'Máy tính có cài Figma'],
        objectives: ['Thiết kế UI chuyên nghiệp', 'Tạo Design System'],
        targetAudience: ['Designer mới', 'Developer muốn học UI'],
        status: 'published',
        publishedAt: '2024-01-15T10:00:00Z',
        isFeatured: true,
        isFree: false,
        instructor: const CourseInstructorDto(id: 'teacher-001', name: 'Nguyễn Văn A', avatar: 'https://i.pravatar.cc/150?u=teacher1'),
        category: const CourseCategoryDto(id: 'cat-design', name: 'Design', slug: 'design'),
        tags: const [CourseTagDto(id: 'tag-1', name: 'UI/UX', slug: 'ui-ux')],
      ...
      const CourseModel(
        ...
        slug: 'lap-trinh-reactjs-thuc-chien',
        shortDescription: 'Học ReactJS từ cơ bản đến nâng cao',
      ...
      const CourseModel(
        ...
        title: 'Quản trị Dự án Agile Mastery',
        slug: 'quan-tri-du-an-agile-mastery',
        shortDescription: 'Làm chủ Agile và Scrum',
      ...
      const CourseModel(
        ...
        shortDescription: 'Xây dựng app mobile với Flutter',
      ...
      const CourseModel(
        ...
        slug: 'data-science-voi-python',
        shortDescription: 'Phân tích dữ liệu chuyên nghiệp',
      ...
      const CourseModel(
        ...
        shortDescription: 'Chiến lược marketing số hiệu quả',
