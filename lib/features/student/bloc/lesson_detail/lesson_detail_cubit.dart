...
class LessonDetailCubit extends Cubit<LessonDetailState> {
  LessonDetailCubit({required this.lessonId})
  ...
  Future<void> load() async {
    ...
    try {
      ...
      emit(LessonDetailLoaded(detail: _mockForLesson(lessonId)));
    } catch (e) {
      emit(LessonDetailFailure(message: e.toString()));
    }
  }

  LessonDetailModel _mockForLesson(String id) {
    return switch (id) {
  ...
  /// All tabs fully populated with rich data.
  LessonDetailModel _fullLesson() {
    return const LessonDetailModel(
      ...
      contentSections: [
        LessonContentSection(
          ...
          subtitle:
              'Lich su va ly do tai sao cac doanh nghiep dich chuyen.',
        ),
        LessonContentSection(
          id: 'cs2',
          order: 2,
          ...
          subtitle:
              'Cach cac dich vu tim thay va giao tiep voi nhau.',
        ),
        LessonContentSection(
          id: 'cs3',
          order: 3,
        ...
        LessonContentSection(
          ...
          subtitle:
              'Xay dung he thong co kha nang chiu loi cao.',
        ),
      ],
      materials: [
        LessonMaterial(
  ...
  /// Has overview & materials, but NO homework and NO quiz.
  LessonDetailModel _noHomeworkNoQuiz() {
    return const LessonDetailModel(
      id: 'l-no-hw-quiz',
  ...
  /// Has overview, homework, quiz — but NO materials.
  LessonDetailModel _noMaterials() {
    return const LessonDetailModel(
      id: 'l-no-mat',
  ...
  /// Almost empty — only title, instructor. Tests all empty states.
  LessonDetailModel _minimalLesson() {
    return const LessonDetailModel(
      id: 'l-minimal',
