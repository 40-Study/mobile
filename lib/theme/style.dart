...
class MaterialTheme {
  ...
  static ColorScheme yellowLightScheme() {
    // Mapped từ theme web (Tailwind + CSS variables):
    // primary:  #0ea5e9 (199 89% 48%)
    // secondary:#a855f7 (271 91% 65%)
    // background: #ffffff, foreground: gần #020617
    return const ColorScheme(
      ...
      // Tertiary dùng green làm accent phụ.
      ...
      // Các mức surface container dựa trên muted / accent của web.
  ...
  static ColorScheme yellowDarkScheme() {
    // Mapped từ .dark web theme:
    // background: 222.2 84% 4.9% (~#020617), foreground: 210 40% 98%
    return const ColorScheme(
      ...
      outlineVariant: Color(0xff1f2933),
      shadow: Color(0xff000000),
      scrim: Color(0xff000000),
      ...
      surfaceContainerLow: Color(0xff030712),
      surfaceContainer: Color(0xff020617),
      surfaceContainerHigh: Color(0xff111827),
      surfaceContainerHighest: Color(0xff1f2933),
    );
  }
