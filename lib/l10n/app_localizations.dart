...
/// App localized strings. Use [AppLocalizations.of](context); add
/// [localizationsDelegates] and [supportedLocales] to [MaterialApp].
abstract class AppLocalizations {
  ...
  /// Supported locales for [MaterialApp.supportedLocales].
